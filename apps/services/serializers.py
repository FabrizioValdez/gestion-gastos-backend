...
class Catalogo_servicioSerializer(serializers.ModelSerializer):
    tipo_servicio_nombre = serializers.CharField(
        source="tipo_servicio.nombre", read_only=True
    )
...
class Servicio_usuarioSerializer(serializers.ModelSerializer):
    ...
    catalogo_servicio_nombre = serializers.CharField(
        source="catalogo_servicio.nombre", read_only=True
    )
...
class Historial_pagoSerializer(serializers.ModelSerializer):
    ...
    def get_servicio_usuario_nombre(self, obj):
        return (
            obj.servicio_usuario.nombre_servicio
            or obj.servicio_usuario.catalogo_servicio.nombre
        )
